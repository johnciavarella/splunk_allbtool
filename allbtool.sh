...
#########################################
#### Varibables
declare -a modules=("alert_actions" "app" "audit" "authentication" "authorize" "checklist" "collections" "commands" "crawl" "datamodels" "deploymentclient" "distsearch" "event_renderers" "eventtypes" "fields" "indexes" "inputs" "instance.cfg" "limits" "literals" "macros" "multikv" "outputs" "passwords" "procmon-filters" "props" "pubsub" "restmap" "savedsearches" "searchbnf" "segmenters" "server" "serverclass" "source-classifier" "sourcetypes" "tags" "telemetry" "times" "transactiontypes" "transforms" "ui-prefs" "user-seed" "visualizations" "viewstates" "web" "wmi" "workflow_actions")
hostName=`hostname`
date=`date +%s`
date2=`date`
